...
function draw() {
  ...
  if (World.frameCount % 150 == 0) {
   ...
   if(pinkCG.isTouching(mainCyclist)){
    ...
    text("Precione seta para cima para reiniciar!",250,200);
  
  
    path.velocityX = 0;
    mainCyclist.velocityY = 0;
    mainCyclist.addAnimation("deadSahilRunning",mainRacerImg2);
    mainCyclist.changeAnimation("deadSahilRunning",mainRacerImg2);
